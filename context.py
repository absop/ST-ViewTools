...
class ContextDeleteToCommand(sublime_plugin.TextCommand):
...
class ContextFindToCommand(sublime_plugin.TextCommand):
    def run(self, edit, to="eof"):
...
class ContextNumberSelectionsCommand(sublime_plugin.TextCommand):
...
class ContextRemoveCommentCommand(sublime_plugin.TextCommand):
    def run(self, edit):
